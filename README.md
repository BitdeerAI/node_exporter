...
| pressure         | Exposes pressure stall statistics from `/proc/pressure/`.                                                     | Linux (kernel 4.20+ and/or [CONFIG_PSI](https://www.kernel.org/doc/html/latest/accounting/psi.html)) |
